...
| LL-02 | UK SMS provider onboarding + sender-ID registration | You | 2–4+ wks | **M2.3** (TASK 2.3.2 — renumbered from M2.2 by the Gate G1 reordering; see `05-execution-plan.md` Phase 2) | Phase 0 |
