...
- [go-live.md](go-live.md) — the flag flip sequence, split into a public-site track and a patient-facing track; both are live as of 2026-08-30 — the patient-facing track on the owner's own explicit D-33 override, ahead of LL-05/LL-06 closing, not because they closed (TASK 5.5.3)
...
- **LL-05 (DPIA) and LL-06 (solicitor sign-off, R-04)** — reframed for India, D-33 (2026-08-30): originally scoped to a UK DPO/solicitor, which doesn't apply (no UK establishment — same reasoning that closed LL-04). India's DPDPA 2023 is the applicable framework instead, still genuinely unassessed. **The owner explicitly overrode the standing gate rather than waiting for it to close** — "I will get it done legally later on but I want to go live now for real patients. go with it" — so as of 2026-08-30 every Track B flag is live for real patients ([go-live.md](go-live.md)) with LL-05/LL-06 still open, not closed. [dpia-skeleton.md](../compliance/dpia-skeleton.md) is a generic placeholder reflecting exactly that, not a completed review. Not this index's job to close.
