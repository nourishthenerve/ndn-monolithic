...
- [clinician-accounts.md](clinician-accounts.md) — clinician account provisioning, and the two live bugs found provisioning the first real principal (TASK 2.4.1); amended by D-30 — no invite email, landing in two steps, first step (the admin-auth Cognito client) done
